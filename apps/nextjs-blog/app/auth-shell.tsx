    ...
    <div className="auth">
      <aside className="auth__brand">
        ...
        <div className="auth__pitch">
          <h1>
            The publishing app that
            <br />
            <em>checks every write</em>.
          </h1>
          <p>
            A complete Next.js App Router example with public server-rendered reading,
            authenticated server actions, account management, and every recovery flow.
          </p>
